SELECT
    SUM(CASE WHEN score_mcc >= -0.1 AND score_mcc < 0.0 THEN 1 ELSE 0 END) AS bin_01_00,
    SUM(CASE WHEN score_mcc >= 0.0 AND score_mcc < 0.1 THEN 1 ELSE 0 END) AS bin_00_01,
    SUM(CASE WHEN score_mcc >= 0.1 AND score_mcc < 0.2 THEN 1 ELSE 0 END) AS bin_01_02,
    SUM(CASE WHEN score_mcc >= 0.2 AND score_mcc < 0.3 THEN 1 ELSE 0 END) AS bin_02_03,
